...
func GenerateRule(ctx context.Context, p providers.Provider, req *types.RuleGenRequest, ruleEngine *policy.Engine, store storage.EventStore) (*types.RuleGenResponse, error) {
	if p == nil {
